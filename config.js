    ...
    SCHEDULE: [
        {
            ...
            sessions: [
                ...
                { time: '10:30', task: 'Cyber Everywhere All at Once masterclass: Arrivals & setup ', speaker: 'Bozidar Spirovski, Romana Stojceska' },
                { time: '10:40', task: 'Masterclass Theory: Common web application flaws: why they happen, why they persist?', speaker: 'Bozidar Spirovski, Romana Stojceska' },
                { time: '11:10', task: 'Masterclass Practical: Bring up applications, run scans, fingerprint services, manual testing of vulnerabilities', speaker: 'Bozidar Spirovski, Romana Stojceska' },
                { time: '12:00', task: 'Lunch Break', speaker: null },
                { time: '13:00', task: 'Split into teams (YieldBank & CodeOnion). Each team builds their SDLC policy: process, remediation approach, deadlines, deployment controls', speaker: 'Bozidar Spirovski, Romana Stojceska' },
                { time: '14:00', task: 'Both teams present and debate their SDLC summaries', speaker: 'Bozidar Spirovski, Romana Stojceska' },
                { time: '14:15', task: 'Break', speaker: null },
                { time: '14:45', task: 'Final challenge: Prioritize vulnerabilities, justify to the management', speaker: 'Bozidar Spirovski, Romana Stojceska' },
            ]
        },
        {
            id: 'day2',
            ...
            sessions: [
                { time: '09:00', task: 'Cyber Everywhere All at Once masterclass: Arrivals', speaker: 'Bozidar Spirovski, Romana Stojceska' },
                { time: '09:15', task: 'Theory: Disaster Recovery and Business Continuity concepts, RTO/RPO', speaker: 'Bozidar Spirovski, Romana Stojceska' },
                { time: '09:45', task: 'masterclass Practical: Crash the platforms. Teams assess impact and discuss recovery steps', speaker: 'Bozidar Spirovski, Romana Stojceska' },
                { time: '10:45', task: 'Break', speaker: null },
                { time: '11:00', task: 'Build your BIA and BCP policy: impact assessment, contact points, communication and decision processes', speaker: 'Bozidar Spirovski, Romana Stojceska' },
                { time: '12:00', task: 'Lunch Break', speaker: null },
                { time: '13:00', task: 'Both teams present their BIA/BCP and debate', speaker: 'Bozidar Spirovski, Romana Stojceska' },
                { time: '13:15', task: 'Final challenge: A series of unfortunate events - recover and communicate through a multi-stage disaster scenario', speaker: 'Bozidar Spirovski, Romana Stojceska' },
        ...
        },
        {
            ...
            sessions: [
                { time: '09:00', task: 'Cyber Everywhere All at Once masterclass: Arrivals', speaker: 'Bozidar Spirovski, Romana Stojceska' },
                { time: '09:15', task: 'Theory: Incident classification and handling procedures', speaker: 'Bozidar Spirovski, Romana Stojceska' },
                { time: '09:45', task: 'Practical: React to an incident scenario. Make decisions based on your BIA and processes from Day 2', speaker: 'Bozidar Spirovski, Romana Stojceska' },
                { time: '10:45', task: 'Break', speaker: null },
                { time: '11:00', task: 'Theory + exercise - Risk Assessment: how to approach it, how to integrate vendor incidents', speaker: 'Bozidar Spirovski, Romana Stojceska' },
                { time: '12:00', task: 'Lunch Break', speaker: null },
                { time: '13:00', task: 'Final challenge: Build and present a risk assessment', speaker: 'Bozidar Spirovski, Romana Stojceska' },
                { time: '15:00', task: 'Coffee Break', speaker: null },
        ...
        },
        {
            ...
            sessions: [
                { time: '09:00', task: 'Cyber Everywhere All at Once masterclass: Arrivals', speaker: 'Bozidar Spirovski, Romana Stojceska' },
                { time: '09:15', task: 'Theory: Regulatory and customer expectations', speaker: 'Bozidar Spirovski, Romana Stojceska' },
                { time: '09:45', task: 'Practical: Discuss organizational posture, take notes, draft an organizational posture document', speaker: 'Bozidar Spirovski, Romana Stojceska' },
                { time: '10:30', task: 'Break', speaker: null }, 
                { time: '10:40', task: 'Exercise: Answer a customer security questionnaire and prepare for customer meeting', speaker: 'Bozidar Spirovski, Romana Stojceska' },
                { time: '11:20', task: 'Exercise: Prepare evidence and documentation for audit', speaker: null },
                { time: '12:00', task: 'Lunch Break', speaker: null },
                { time: '13:00', task: 'Final challenge: Each team runs two timed meetings with the facilitator - one as a customer, one as an auditor', speaker: 'Bozidar Spirovski, Romana Stojceska' },
                { time: '15:00', task: 'Coffee Break', speaker: null },
