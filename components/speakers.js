...
//         <div class="grid grid-cols-2 lg:grid-cols-3 lg:gap-20 gap-8 md:gap-10">
//             ${speakers.map( (speaker) => `
//                 <div class="group bg-white p-4 rounded-[2.5rem] md:rounded-[3.5rem] border border-slate-200 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-300">
...
//                         <div class="relative mb-6 px-4 pt-4">
...
<section id="speakers" class="py-24 bg-slate-50/50 relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-3 lg:gap-20 gap-8 md:gap-10 mb-6">
            ${onlineSpeakers.map(renderCard).join("")}
        </div>

        <hr class="border border-slate-200">

        <div class="grid grid-cols-2 lg:grid-cols-3 lg:gap-20 gap-8 md:gap-10 mt-6">
