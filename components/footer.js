            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mb-16">
                ...
                <div class="lg:col-span-1">
                    ...
                    <div class="flex gap-4">
                        <a href="#" class="text-slate-400 hover:text-blue-600 transition-colors" aria-label="LinkedIn">
                        ...
                        <a href="#" class="text-slate-400 hover:text-blue-600 transition-colors" aria-label="Facebook">
                        ...
                        <a href="#" class="text-slate-400 hover:text-blue-600 transition-colors" aria-label="Instagram">
                ...
                <div class="lg:flex lg:flex-col lg:items-center">
                    <div class="w-fit">
                        ...
                        ${navItems.map(item => `<li><a href="${item.href}" class="hover:text-blue-600 transition-colors">${item.name}</a></li>`).join('')}
                        </ul>
                    </div>
                </div>
